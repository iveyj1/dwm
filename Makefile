...
install: all
	...
	cp -f dwm dwm-spawn dwm-keymap brightness-up brightness-down ${DESTDIR}${PREFIX}/bin
	chmod 755 ${DESTDIR}${PREFIX}/bin/dwm ${DESTDIR}${PREFIX}/bin/dwm-spawn ${DESTDIR}${PREFIX}/bin/dwm-keymap ${DESTDIR}${PREFIX}/bin/brightness-up ${DESTDIR}${PREFIX}/bin/brightness-down
